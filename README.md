...
Link login : https://toto12poker.net/
    </textarea><br />
  ...
  <script>
    ...
    const prefixList = ["gacor", "jitu", "bola", "manis", "cantik", "motor", "mobil", "sakti", "mantap", "iya2", "bisa", "pasti", "hoki", "cuan", "emas", "super", "gas1", "naga", "maju", "king", "oke1",];
